...
function love.load()
    ...
    player3=Paddle(10,30,20,5)
    player4=Paddle(VIRTUAL_WIDTH-30,VIRTUAL_HEIGHT-10,20,5)
...
function love.draw()
    ...
    love.graphics.print(tostring(player3Score), VIRTUAL_WIDTH / 2 - 25, VIRTUAL_HEIGHT / 3)
    love.graphics.setColor(255, 0, 0)
    love.graphics.print(tostring(player4Score), VIRTUAL_WIDTH / 2 + 5, VIRTUAL_HEIGHT / 3)
    love.graphics.setColor(0, 255, 255)
    player1:render()
    love.graphics.setColor(255, 255, 0)
    player2:render()
